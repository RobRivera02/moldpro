  ...
  return (
    <section className="bg-amazon py-24 sm:py-32 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
        <div className="flex flex-col xl:flex-row items-center gap-x-8 gap-y-10 sm:gap-y-8 xl:items-stretch">
          {/* Founder Image */}
          <motion.div
            ...
            className="-mt-8 w-full max-w-md xl:-mb-8 xl:w-96 xl:flex-none"
          >
            <div className="relative aspect-[3/4] h-full xl:aspect-auto">
              <Image
              ...
              />
              <div className="absolute inset-0 rounded-2xl ring-1 ring-inset ring-[bisque]/10" />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-12"
          >
            <figure className="relative isolate pt-6 sm:pt-12">
              <svg
                ...
                viewBox="0 0 162 128"
                aria-hidden="true"
                className="absolute left-0 top-0 -z-10 h-32 stroke-[bisque]/20"
              >
                <path
              ...
              <h2 className="text-[bisque] text-4xl sm:text-5xl font-primary mb-8 tracking-wide">
                Mensaje del Fundador
              </h2>
              
              <blockquote className="text-xl/8 font-tertiary text-[bisque]/80 sm:text-2xl/9 space-y-6">
                <p>
              ...
              <figcaption className="mt-10">
                ...
                <div className="mt-1 text-[bisque]/60 font-tertiary">Fundador de Tierra y Café</div>
              </figcaption>
            </figure>
          </motion.div>
        </div>
